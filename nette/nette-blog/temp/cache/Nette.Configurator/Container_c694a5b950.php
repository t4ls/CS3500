<?php
// source: /unified/b/brp9209/www/CS3500/nette/nette-blog/app/config/config.neon 
// source: /unified/b/brp9209/www/CS3500/nette/nette-blog/app/config/config.local.neon 

class Container_c694a5b950 extends Nette\DI\Container
{
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => '/unified/b/brp9209/www/CS3500/nette/nette-blog/app',
			'wwwDir' => '/unified/b/brp9209/www/CS3500/nette/nette-blog/www',
			'debugMode' => FALSE,
			'productionMode' => TRUE,
			'environment' => 'production',
			'consoleMode' => FALSE,
			'container' => array('class' => NULL, 'parent' => NULL),
			'tempDir' => '/unified/b/brp9209/www/CS3500/nette/nette-blog/app/../temp',
		));
	}
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('/unified/b/brp9209/www/CS3500/nette/nette-blog/app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/unified/b/brp9209/www/CS3500/nette/nette-blog/app/../temp/cache',
	...
	{
		return new Container_c694a5b950_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	public function createServiceNette__latte()
	{
		...
		trigger_error('Service nette.latte is deprecated, implement Nette\Bridges\ApplicationLatte\ILatteFactory.',
			16384);
		$service->setTempDirectory('/unified/b/brp9209/www/CS3500/nette/nette-blog/app/../temp/cache/latte');
...
final class Container_c694a5b950_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_c694a5b950 $container)
	{
